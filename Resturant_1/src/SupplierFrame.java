...
public class SupplierFrame extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (box.getSelectedIndex() == 0) {
            ...
            String query = "update supplieres set name  = '" + newName + "' where sup_id = " + ID;
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Connecting2DB conn = new Connecting2DB();
        try {
            int ID = Integer.parseInt(JOptionPane.showInputDialog("Enter Supplier ID:"));
            String query = "delete from supplieres where sup_id = " + ID;
            conn.executeDeleteUpdate(query);
        } catch (NumberFormatException NumberFormatException) {
            JOptionPane.showMessageDialog(null, "Enter Numbers Only");
        }
